...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.Set_Gate_Width.setPlaceholderText(
            _translate("Form", "请输入选通门宽,精确到0.1"))
        ...
        self.Set_Sigma.setPlaceholderText(
            _translate("Form", "请输入激光脉宽(半高宽),精确到0.1"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
